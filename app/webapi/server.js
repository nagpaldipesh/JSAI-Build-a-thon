...
const chatModel = new AzureChatOpenAI({
  ...
  // azureOpenAIEndpoint: process.env.AZURE_INFERENCE_SDK_ENDPOINT, // In target url: https://<RESOURCE_NAME>.openai.azure.com/
...
app.listen(PORT, () => {
  ...
  // console.log("Project pdf directory:", pdfPath);
